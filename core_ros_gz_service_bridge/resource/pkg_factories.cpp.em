// generated from core_ros_gz_service_bridge/resource/pkg_factories.cpp.em
...
#include "factory.hpp"
#include "core_ros_gz_service_bridge/convert/@(ros2_package_name).hpp"
...
>::convert_ros_to_gz(
  ...
  @(m.ign_type()) & gz_msg)
{
  core_ros_gz_service_bridge::convert_ros_to_gz(ros_msg, gz_msg);
}
...
>::convert_gz_to_ros(
  ...
  @(m.ros2_type()) & ros_msg)
{
  core_ros_gz_service_bridge::convert_gz_to_ros(gz_msg, ros_msg);
}
@[end for]@
